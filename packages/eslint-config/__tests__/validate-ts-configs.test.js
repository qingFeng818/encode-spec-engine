...
describe('Validate TS configs', () => {
  it('Validate encode-eslint-config/typescript', async () => {
  ...
  it('Validate encode-eslint-config/typescript/vue', async () => {
  ...
  it('Validate encode-eslint-config/essential/typescript', async () => {
  ...
  it('Validate encode-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate encode-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate encode-eslint-config/typescript/node', async () => {
