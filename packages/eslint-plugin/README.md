# encode-spec-engine-eslint-plugin
...
```shell
$ npm install encode-spec-engine-eslint-plugin eslint --save-dev
```
...
// .eslintrc.js
module.exports = {
  extends: 'plugin:encode-spec-engine-eslint-plugin/recommended',
};
```
