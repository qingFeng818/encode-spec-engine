        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, (0, fast_glob_1.default)(pattern, { cwd: options.cwd, ignore: constants_1.PRETTIER_IGNORE_PATTERN })];
                case 2:
                    files = _a.sent();
                    _a.label = 3;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    opitons = _a.sent();
                    formatted = prettier_1.default.format(text, __assign(__assign({}, opitons), { filepath: filepath }));
