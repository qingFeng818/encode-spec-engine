...
exports.default = (function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var cwd, fix, outputReport, scanConfig, readConfigFile, pkg, config, runErrors, results, eslintResults, error_1, stylelintResults, e_1, markdownlintResults, e_2, reportPath;
        ...
        switch (_a.label) {
            case 0:
                ...
                readConfigFile = function (pth) {
                    var locaPath = path_1.default.resolve(cwd, pth);
                    return fs_extra_1.default.existsSync(locaPath) ? require(locaPath) : {};
                };
